...
public class CheckOutFragment extends Fragment {
    ...
    // ====================================================
    // Buy Now සඳහා — Cart bypass කළ items list
    // isBuyNow = true නම් cart load නොකර මේ list use කරනවා
    // ====================================================
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // SingleProductFragment එකෙන් BuyNow data ආවද බලනවා
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // =============================================
        // Order Summary Load
        // isBuyNow = true  → BuyNow items use කරනවා
        // isBuyNow = false → Firebase cart load කරනවා
        // =============================================
        final double DELIVERY_FEE = 100.00;
        binding.orderItemsContainer.removeAllViews();
        ...
        binding.btnConfirmOrder.setOnClickListener(view1 -> {
            ...
            if (selectedPaymentId == binding.radioCard.getId()) {
                ...
                // isBuyNow නම් buyNowItems use කරනවා, නැත්නම් cart load කරනවා
    ...
    // Order Summary UI populate කිරීම
